...
const MESSAGE_CATALOG : { [key: string]: string } = {
    ...
    MinVersionForAbstractVirtualClassesWithPrivateMethodRuleDescription:
        `Detects private methods within abstract/virtual classes`,
    
    MinVersionForAbstractVirtualClassesWithPrivateMethodRuleMessage:
        `Found private methods within abstract/virtual classes. Make sure the corresponding API version of the class is at least v61.0. If so, you can ignore this rule.`,
